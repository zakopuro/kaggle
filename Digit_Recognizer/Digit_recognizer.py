...
#%%
data_dir	= '/Users/zakopuro/Code/python_code/kaggle/Digit_Recognizer/input/'
...
ax[1].plot(history.history['acc'],color = 'b',label = 'Trainig accuracy')
ax[1].plot(history.history['val_acc'],color='r',label = 'Validatin accuracy')
